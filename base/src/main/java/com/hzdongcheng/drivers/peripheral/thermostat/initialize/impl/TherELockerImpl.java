 ...
 * @version V1.0     
 */
package com.hzdongcheng.drivers.peripheral.thermostat.initialize.impl;

import com.hzdongcheng.drivers.peripheral.thermostat.initialize.AbstractTherELocker;
...
* @version 1.0 
*/
public final class TherELockerImpl extends AbstractTherELocker{
	...
	*/
	public void open(String portName) throws NotFoundSerialLibraryException, InitializeSerialPortException, SerialPortErrorException {
		...
		try{
			//初始化串口
			serialPort.initialize(SerialPortBase.DCDZ_CBR_9600, SerialPortBase.DCDZ_NOPARITY, 
